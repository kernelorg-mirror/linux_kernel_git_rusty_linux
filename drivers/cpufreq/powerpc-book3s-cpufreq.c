...
/* Power Management SPRs in POWER8 */

#define SPRN_PMCR	884 /* PM Control Reg */
#define SPRN_PMICR	852 /* PM Idle Control Reg */
#define SPRN_PMSR	853 /* PM Status Reg */
			      ...
			      unsigned int relation)
{
	...
	pr_debug("setting frequency for cpu %d to %d kHz (index %d)",
		 policy->cpu,
